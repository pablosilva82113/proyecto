...
class CarrerasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrera" do
    assert_difference("Carrera.count") do
      post carreras_url, params: { carrera: { carrera: @carrera.carrera, siglas: @carrera.siglas } }
    end
  ...
  test "should update carrera" do
    patch carrera_url(@carrera), params: { carrera: { carrera: @carrera.carrera, siglas: @carrera.siglas } }
