...
class EspecialidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create especialidad" do
    assert_difference("Especialidad.count") do
      post especialidades_url, params: { especialidad: { nombre_especialidad: @especialidad.nombre_especialidad } }
    end
  ...
  test "should update especialidad" do
    patch especialidad_url(@especialidad), params: { especialidad: { nombre_especialidad: @especialidad.nombre_especialidad } }
