class DocentesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @docente.save
        format.html { redirect_to docente_url(@docente), notice: "Docente was successfully created." }
  ...
  def update
    respond_to do |format|
      if @docente.update(docente_params)
        format.html { redirect_to docente_url(@docente), notice: "Docente was successfully updated." }
  ...
  private
    ...
    def docente_params
      params.require(:docente).permit(:user_id, :nombre, :apellido_p, :apellido_m)
    end
end
